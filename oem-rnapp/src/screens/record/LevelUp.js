...
class Screen extends Component {
        ...
        <FlatList
          ...
          renderItem={({item}) => (
            <View style={{marginBottom: 10, paddingBottom: 10, backgroundColor:'#ffffff', borderTopLeftRadius: 6}}>
              <View style={{flexDirection:'row', paddingTop:18, paddingLeft: 15, paddingRight: 15, borderLeftWidth:6, borderColor: '#FF487B', borderTopLeftRadius: 6}}>
  ...
  async reload(refresh){
    ...
    const resp_list = (await axios.get('/api/my/user_level_order_income', { params: {
      order: 'create_time',
      status: 2,
      offset,
      limit: 20,
