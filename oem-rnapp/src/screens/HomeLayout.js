...
export default createBottomTabNavigator({
  ...
  market: {
    ...
    navigationOptions: {
      tabBarLabel: 'Hello客',
      tabBarIcon: ({ focused }) => {
        return <Image source={focused ? require('../assets/tabbar-market-focused.png') : require('../assets/tabbar-market.png')} style={{width:24}} />
      }
    }
  },
  forum: {
    ...
    navigationOptions: {
      tabBarLabel: '论坛',
      tabBarIcon: ({ focused }) => {
        return <Image source={focused ? require('../assets/tabbar-forum-focused.png') : require('../assets/tabbar-forum.png')} style={{width:24}} />
      }
    }
  },
  my: {
