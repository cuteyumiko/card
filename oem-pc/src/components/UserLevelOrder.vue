<template>
  <div style="padding:10px;display:flex:1;">
    ...
    <div style="display:flex;">
      <el-form :inline="true">
        <el-form-item>
          <el-input v-model="search.order_code__like" placeholder="订单号"></el-input>
        </el-form-item>
        <el-form-item>
          <el-input v-model="search.creator_name__like" placeholder="提交人"></el-input>
        </el-form-item>
        <el-form-item>
          <el-input v-model="search.creator_mobile__like" placeholder="提交人手机号"></el-input>
        </el-form-item>
      </el-form>
    </div>
    ...
    <div v-loading="loading">
      <el-table :data="list" style="width: 100%;" @sort-change="sortChange" :default-sort="{prop: 'create_time', order: 'descending'}">
        ...
        <el-table-column prop="name" label="产品" width="200"></el-table-column>
...
export default {
  data() {
    return {
      search: { current: 1, size: 10, level_order_id__not: '' },
      list: [],
      total: 0,
      loading: false,
    };
