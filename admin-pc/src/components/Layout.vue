<template>
  <div style="display:flex;flex-direction:column;">
    <div style="background:#05002a;height:64px;display:flex;align-items:center;padding:0 10px;">
      <div style="flex:1;color:#fff;font-size:24px;">HelloCardSAAS云平台</div>
...
const menuTree = [
  ...
  { name: '产品管理',
    ...
    children: [
      { name: '信用卡', path: '/product_card', resCode: 'user_manager' },
      { name: '贷款', path: '/product_loan', resCode: 'role_manager' },
      { name: '积分券', path: '/product_ticket', resCode: 'role_manager' },
    ],
  },
  { name: '订单管理',
    icon: 'lt lt-iconset0250',
  ...
  { name: '第三方通道',
    ...
    children: [
      { name: '短信通道', path: '/sms' },
      { name: '支付通道', path: '/payment' },
      { name: '代付通道', path: '/agentpay' },
      { name: '绑卡通道', path: '/bindcard' },
      { name: '积分券处理通道', path: '/product_ticket_process' },
    ],
  },
