<template>
  <div style="padding:10px;display:flex:1;">
    <div style="display:flex;align-items:center;">
      <el-button icon="el-icon-d-arrow-left" type="primary" size="small" @click="$router.push('/stat_ticket')">返回优惠券收入</el-button>
      <h2 style="flex:1;text-align:center;"> 优惠券收入订单 </h2>
